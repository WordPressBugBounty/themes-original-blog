<?php
if ( ! class_exists( 'Original_Blog_Featured_Posts_Widget' ) ) {
	/**
	 * Adds Original Blog Featured Posts Widget.
	 */
	class Original_Blog_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$featured_posts_widget = array(
				'classname'   => 'widget original-blog-widget featured-widget',
				'description' => __( 'Retrive Posts List Widgets', 'original-blog' ),
			);
			parent::__construct(
				'original_blog_featured_posts_widget',
				__( 'Artify Widget: Featured Posts Widget', 'original-blog' ),
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'original-blog' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'original-blog' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">
					<?php
					$categories = original_blog_get_post_cat_choices();
